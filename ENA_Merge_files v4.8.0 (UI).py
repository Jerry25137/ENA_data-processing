...
class ENA_App:
    def __init__(self, root):
        ...
        # 讀取數據方式選項 ---------------------------------------------------------------------------------------
        self.radio_frame_file = ttk.LabelFrame(root, text = "讀取數據方式：", relief = "groove", borderwidth = 2)
        ...
        # ENA數據資料選項：第1行 ------------------------------------------------------------------------------
        self.frame1 = ttk.LabelFrame(root, text = "ENA數據資料：", relief = "groove", borderwidth = 2)
